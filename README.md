...
### 🎨 **المصاحف الملونة**
- عرض المصحف بألوان تعكس أحكام التجويد المختلفة (14 قاعدة ملوّنة في رواية ورش).
...
1. **استنساخ المستودع**:
```bash
git clone https://github.com/MassahifAlossol-Nouari/Maktouba.git
فتح الملف:
...
<div align="center"> <sub>💡 مشروع مفتوح المصدر - نسأل الله التوفيق والسداد</sub> </div>
