...
function exportToCSV() {
    ...
    let headers = ['عدد', 'السورة', 'رقم الاية', 'الصفحة', 'الكلمة', 'اللون', 'نوع اللون'];
...
function getColorCode(colorCode) {
    const colors = {
        ...
        'c4': '#FFC000',    /*   الامالة أوالتقليل  */
        'c5': '#5B9BD5',    /*   البسملة بين السورتين   */
        'c6': '#002060',    /*   علامات الوقف أو الأرباع */
        'c7': '#00B0F0',    /*   الهمز المفرد أوالمزدوج   */
        'c8': '#00FF00',    /*   تغليظ اللام  */
        'c9': '#0000FF',    /*   النقل أوالسكت  */
        'c10': '#00FFFF',   /*   مد البدل لورش  */
        'c11': '#ED7D31',   /*    ترقيق راء ورش */
        'c12': '#FF0066',   /*   ميم الجمع  */
        'c13': '#CC00CC',   /*   مد اللين لورش  */
        'c14': '#C00000',   /*   الياءات المتطرفة  */
        'c15': '#0070C0',   /*   الادغام أوالاظهار  */
        'c16': '#00B050',   /*   تحريك الساكن  */
        'c17': '#7030A0',   /*   الانفرادات  */
        'c18': '#548235',   /*   هاء الكناية  */
        'c19': '#CC0099',   /*   ٱلوقف على ٱلهمز  */
        'c20': '#92D050',   /*   الاشمام أوالاختلاس  */
        'c21': '#970573',   /*   ٱلوقف على أواخر الكلم  */
        'c22': '#FFFF00',   /*   1قاعدة   */
        'c23': '#FFFF00',   /*   1قاعدة   */
        'c24': '#FFFF00',   /*   1قاعدة   */
        'c25': '#FFFF00'   /*   1قاعدة   */
...
<body>
    ...
    <table>
        <thead>
            <tr><th>عدد</th><th>السورة</th><th>رقم الاية</th><th>الصفحة</th><th>الكلمة</th><th>اللون</th><th>نوع اللون</th></tr>
        </thead>
        <tbody>`;
...
function exportToExcel() {
    ...
    // تحضير البيانات
    let data = [['عدد', 'السورة', 'رقم الاية', 'الصفحة', 'الكلمة', 'اللون', 'نوع اللون']];
    ...
    let tableHtml = `<table border="1" cellpadding="8" cellspacing="0" dir="rtl" style="border-collapse: collapse; font-family: 'Amiri', 'Traditional Arabic', 'NouariAbdelkabir', serif; font-size: 14px;">
        <thead>
            <tr style="background-color: #c9a86b; color: #2e241a;">
                ...
                <th style="padding: 8px; border: 1px solid #ddd;">رقم الاية</th>
...
function getPlainTextTable(data) {
    let rows = [['عدد', 'السورة', 'رقم الاية', 'الصفحة', 'الكلمة', 'اللون', 'نوع اللون']];
