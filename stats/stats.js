...
const colorInfo = {
    'c1': { icon: '🔴', name: 'الفرشية' },
    'c2': { icon: '🟤', name: 'عد الآيات' },
    'c3': { icon: '🌸', name: 'الإدغام الكبير' },
    'c4': { icon: '📀', name: 'الإمالة والتقليل' },
    'c5': { icon: '🔵', name: 'البسملة' },
    'c6': { icon: '🔵', name: 'علامات الوقف' },
    'c7': { icon: '🔵', name: 'الهمز المفرد' },
    'c8': { icon: '🟢', name: 'اللامات لورش' },
    'c9': { icon: '🔵', name: 'النقل والسكت' },
    'c10': { icon: '🔵', name: 'مد البدل' },
    'c11': { icon: '🟠', name: 'الراءات لورش' },
    'c12': { icon: '🌸', name: 'ميم الجمع' },
    'c13': { icon: '🟣', name: 'مد اللين' },
    'c14': { icon: '🔴', name: 'الياءات المتطرفة' },
    'c15': { icon: '🔵', name: 'الإدغام والإظهار' },
    'c16': { icon: '🟢', name: 'تحريك الساكن' },
    'c17': { icon: '🟣', name: 'الانفرادات' },
    'c18': { icon: '🟢', name: 'هاء الكناية' },
    'c19': { icon: '🌸', name: 'الوقف على الهمز' },
    'c20': { icon: '🟢', name: 'الاختلاس والاشمام' },
    'c21': { icon: '🔴', name: 'الوقف على أواخر الكلم' },
    'c22': { icon: '🟡', name: 'قاعدة 22' },
    'c23': { icon: '🟡', name: 'قاعدة 23' },
    'c24': { icon: '🟡', name: 'قاعدة 24' },
    'c25': { icon: '🟡', name: 'قاعدة 25' }
};
...
function displayTable(data) {
    ...
    for (let i = 0; i < filteredData.length; i++) {
        ...
        // ===== التعديل هنا: حساب الحروف الأساسية فقط =====
        const cleanWord = item.word.replace(/[\u064B-\u065F\u0670\u0640]/g, '');
        row.insertCell(6).textContent = cleanWord.length;
        ...
        row.onclick = function(e) {
            ...
            let sura = this.cells[1].textContent;
