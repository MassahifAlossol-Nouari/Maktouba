...
// ابحث عن هذا الجزء في دالة mobileSearch وأضف التظليل
...
// ==================== إخفاء/إظهار الشرائط للهواتف (نسخة مطورة) ====================
...
function hideAll() {
    ...
    console.log('تم إخفاء الشرائط بالكامل');
}
...
if (window.innerWidth <= 768) {
    ...
    // الضغط في أي مكان (بما في ذلك الشريط السفلي)
