...
const qiraatData = {
    ...
    hamza: { name: "الإمام حمزة الكوفي", rawis: [{ id: "khalaf", name: "رواية خلف بالسكت على ال وشيء", file: "mushaf_khalaf1.js" },{ id: "khalaf", name: "رواية خلف بالسكت على ال وشيء والمفصول", file: "mushaf_khalaf2.js" }, { id: "khallad", name: "رواية خلاد بالسكت على ال وشيء", file: "mushaf_khallad1.js" }, { id: "khallad", name: "رواية خلاد بلا سكت", file: "mushaf_khallad2.js" }] },
...
(function() {
    ...
    const colorItems = [
        ...
        { name: 'عد الآيات', color: '#C65911' },
        { name: 'الإدغام الكبير', color: '#FF00FF' },
        { name: 'الإمالة والتقليل', color: '#FFC000' },
        { name: 'البسملة بين السورتين', color: '#5B9BD5' },
        { name: 'علامات الوقف', color: '#002060' },
        { name: 'الهمز المفرد والمزدوج', color: '#00B0F0' },
        { name: 'اللامات لورش', color: '#00FF00' },
        { name: 'النقل والسكت', color: '#0000FF' },
        { name: 'مد البدل لورش', color: '#00FFFF' },
        { name: 'الراءات لورش', color: '#ED7D31' },
        { name: 'ميم الجمع', color: '#FF0066' },
        { name: 'مد اللين لورش', color: '#CC00CC' },
