...
const qiraatData = {
    nafi: { name: "الإمام نافع المدني", rawis: [{ id: "qalun", name: "رواية قالون (قصر/إسكان)", file: "mushaf_qalun1.js" },{ id: "qalun", name: "رواية قالون (قصر/صلة)", file: "mushaf_qalun2.js" },{ id: "qalun", name: "رواية قالون (توسط/إسكان)", file: "mushaf_qalun3.js" },{ id: "qalun", name: "رواية قالون (توسط/صلة)", file: "mushaf_qalun4.js" }, { id: "warsh", name: "رواية ورش (قصر البدل/فتح)", file: "mushaf_warsh1.js" }, { id: "warsh", name: "رواية ورش (توسط البدل/تقليل)", file: "mushaf_warsh2.js" }, { id: "warsh", name: "رواية ورش (إشباع البدل/الفتح)", file: "mushaf_warsh3.js" }, { id: "warsh", name: "رواية ورش (إشباع البدل/تقليل)", file: "mushaf_warsh4.js" }, { id: "warsh", name: "رواية ورش (طريق الأصبهاني)", file: "mushaf_warsh5.js" }] },
    ibnKathir: { name: "الإمام ابن كثير المكي", rawis: [{ id: "bazzi", name: "رواية البزي", file: "mushaf_bazzi.js" }, { id: "qunbul", name: "رواية قنبل", file: "mushaf_qunbul.js" }] },
    abuAmr: { name: "الإمام أبو عمرو البصري", rawis: [{ id: "doori", name: "رواية الدوري (توسط المنفصل)", file: "mushaf_doori.js" },{ id: "doori", name: "رواية الدوري (قصر المنفصل)", file: "mushaf_doori1.js" }, { id: "soosi", name: "رواية السوسي", file: "mushaf_soosi.js" }] },
    ibnAmir: { name: "الإمام ابن عامر الشامي", rawis: [{ id: "hisham", name: "رواية هشام", file: "mushaf_hisham.js" }, { id: "ibnDhakwan", name: "رواية ابن ذكوان", file: "mushaf_ibnDhakwan.js" }] },
    asim: { name: "الإمام عاصم الكوفي", rawis: [{ id: "hafs", name: "رواية حفص", file: "mushaf_hafs.js" }, { id: "shubah", name: "رواية شعبة", file: "mushaf_shubah.js" }] },
    hamza: { name: "الإمام حمزة الكوفي", rawis: [{ id: "khalaf", name: "رواية خلف", file: "mushaf_khalaf.js" }, { id: "khallad", name: "رواية خلاد", file: "mushaf_khallad.js" }] },
    kisai: { name: "الإمام الكسائي الكوفي", rawis: [{ id: "abuHarith", name: "رواية أبو الحارث", file: "mushaf_abuHarith.js" }, { id: "dooriKisai", name: "رواية الدوري", file: "mushaf_doori_kisai.js" }] },
...
function convertColorsToInlineStyles(element) {
    const colorClasses = {
        ...
        'c21': '#970573', 'c22': '#833C0C', 'c23': '#FFFF00', 'c24': '#FFFF00', 'c25': '#FFFF00'
    };
...
async function copyPageWithColors() {
    ...
    if (highlightedAyah) {
        ...
        showToast('📋 تم نسخ الآية مع ألوانها', 1500);
    } else {
...
function updateCopyButtonText() {
    ...
    copyButtons.forEach(btn => {
        ...
        btn.title = `نسخ ${highlighted ? 'الآية المحددة' : (currentMode === 'double' ? 'الصفحتين' : (currentMode === 'compare' ? 'المقارنة' : 'الصفحة'))} مع التنسيق والألوان`;
    });
}
...
// تحويل زر البحث في الهواتف إلى زر نسخ
function convertMobileSearchToCopy() {
    // البحث عن زر البحث في قائمة الهاتف
    const mobileSearchBtn = document.getElementById('mobileSearchBtn');
    const mobileSearchInMenu = document.querySelector('#leftMenu .menu-item#searchBtn');
    const mobileSearchInList = document.querySelector('#mobileSearchBtn');
    
    // قائمة بجميع أزرار البحث المحتملة في الهاتف
    const mobileButtons = [
        mobileSearchBtn,
        mobileSearchInMenu,
        mobileSearchInList,
        document.querySelector('.mobile-search-btn'),
        document.querySelector('#leftMenu #searchBtn')
    ].filter(btn => btn !== null);
    
    mobileButtons.forEach(btn => {
        if (btn && btn.id !== 'searchBtn') {
            // تغيير النص والأيقونة
            btn.innerHTML = '📋 نسخ';
            btn.title = 'نسخ المحتوى مع التنسيق والألوان';
            btn.classList.add('copy-btn-mobile');
            
            // إزالة الحدث القديم وإضافة الحدث الجديد
            const newBtn = btn.cloneNode(true);
            btn.parentNode.replaceChild(newBtn, btn);
            ...
            newBtn.addEventListener('click', function(e) {
                ...
                e.stopPropagation();
                copyPageWithColors();
                // إغلاق القائمة الجانبية بعد النسخ (اختياري)
                closeLeftMenu();
            });
        }
    });
