...
const reciterMapping = {
    ...
    "mushaf_hisham": { name: "محمد إسماعيل دبان - رواية هشام عن ابن عامر", code: "deban/Rewayat-Hesham-A-n-Abi-A-mer", available: true },   // السور غير مكتملة)
    ...
    "mushaf_khallad": { name: "مفتاح سُلطاني - رواية خلاد عن حمزة", code: "Al-Quran_riwayat_Khallad_tilawat_Moftah_Assultany", available: true },
    "mushaf_abuHarith": { name: "عبد الرشيد صوفي - رواية أبي الحارث", code: "soufi/Rewayat-Abi-Al-Harith", available: true },
    "mushaf_ibnWardan": { name: "", code: "", available: false, waitMessage: "سيتم إضافة القارئ المناسب قريباً" },
    "mushaf_ibnJammaz": { name: "", code: "", available: false, waitMessage: "سيتم إضافة القارئ المناسب قريباً" },
    "mushaf_ruways": { name: "", code: "", available: false, waitMessage: "سيتم إضافة القارئ المناسب قريباً" },
    "mushaf_ruh": { name: "", code: "", available: false, waitMessage: "سيتم إضافة القارئ المناسب قريباً" },
    "mushaf_ishaq": { name: "", code: "", available: false, waitMessage: "سيتم إضافة القارئ المناسب قريباً" },
    "mushaf_idris": { name: "", code: "", available: false, waitMessage: "سيتم إضافة القارئ المناسب قريباً" }
};
...
function playSurah() {
    ...
    // 1. رواية أبي الحارث (هاني رضوان - archive.org)
    if (reciterCode === 'a625_202506a') {
        audioUrl = `https://archive.org/download/${reciterCode}/${suraNum}.mp3`;
        console.log('تشغيل رواية أبي الحارث:', audioUrl);
    }
