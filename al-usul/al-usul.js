...
const BAB_FILES = [
    ...
    { id: 6, file: 'bab-006.json', title: 'الإدغام الكبير (المتقاربين والمتجانسين )', class: 'c3' },
    ...
    { id: 26, file: 'bab-026.json', title: 'الياءات الزوائد', class: 'c24' },
...
// ============================
document.addEventListener('DOMContentLoaded', function() {
    const scrollBtn = document.querySelector('.action-btn[title="العودة إلى الأعلى"]');
    if (scrollBtn) {
